        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaravanType = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CaravanRentOffer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Caravan_CaravanRentOffers",
                        column: x => x.CaravanId,
                        principalTable: "Caravan",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CaravanRentOfferId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ChangedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ChangedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favourite_CaravanRentOffer",
                        column: x => x.CaravanRentOfferId,
                        principalTable: "CaravanRentOffer",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rating_CaravanRentOffer",
                        column: x => x.CaravanRentOfferId,
                        principalTable: "CaravanRentOffer",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CaravanRentOffer_CaravanId",
                table: "CaravanRentOffer",
                column: "CaravanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favourite_CaravanRentOfferId",
                table: "Favourite",
                column: "CaravanRentOfferId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rating_CaravanRentOfferId",
                table: "Rating",
                column: "CaravanRentOfferId");
